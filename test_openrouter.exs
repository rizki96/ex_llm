...
if ExLLM.Providers.OpenRouter.configured?() do
  IO.puts("✓ OpenRouter provider is configured")
else
  IO.puts("❌ OpenRouter provider is not configured")
  IO.puts("Make sure OPENROUTER_API_KEY is set in environment")
  System.halt(1)
end

# 2. Test basic chat
IO.puts("\n2. Testing basic chat...")
case ExLLM.chat(:openrouter, [
...
], callback, model: "openai/gpt-4o-mini") do
  :ok ->
...
IO.puts("\n✅ OpenRouter provider tests complete!")
...
result = ExLLM.Infrastructure.Retry.with_circuit_breaker_retry(fn ->
...
for i <- 1..3 do
  IO.puts("  Failure #{i}")
  ExLLM.Infrastructure.Retry.with_circuit_breaker_retry(fn ->
...
result = ExLLM.Infrastructure.CircuitBreaker.call("direct_test", fn ->
  {:ok, "direct success"}
end)

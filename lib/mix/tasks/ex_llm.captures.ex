defmodule Mix.Tasks.ExLlm.Captures do
  ...
  defp show_capture(timestamp) do
    ...
    matching_keys = LiveApiCacheStorage.list_cache_keys()
  ...
  defp clear_captures(opts) do
    ...
    old_keys = Enum.filter(keys, fn key ->
    ...
    Mix.shell().info("Note: Manual deletion not yet implemented. Captures will be cleaned up by the automatic retention policy.")
  end

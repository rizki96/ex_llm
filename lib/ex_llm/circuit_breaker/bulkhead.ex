defmodule ExLLM.CircuitBreaker.Bulkhead do
  ...
  ## Usage
      ...
      ExLLM.CircuitBreaker.Bulkhead.configure("api_circuit",
        max_concurrent: 5,
        max_queued: 20,
        queue_timeout: 3000
      )
      ...
      ExLLM.CircuitBreaker.call_with_bulkhead("api_circuit", fn ->
        # Your API call here
  ...
  alias ExLLM.CircuitBreaker.BulkheadWorker
  ...
  def configure(circuit_name, opts) do
    ...
    # Start or restart the worker for this circuit

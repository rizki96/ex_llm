defmodule ExLLM.Providers.OpenAI.StreamParseResponse do
  @moduledoc """
  Streaming response parser plug for OpenAI provider.

  This plug handles Server-Sent Events (SSE) from OpenAI's streaming API,
  parsing chunks and yielding StreamChunk structs.
  """
  ...
  defp initiate_streaming(request) do
    ...
    chunk_stream =
      ...
      |> Stream.map(&parse_openai_chunk(&1, request.provider))
  ...
  defp parse_openai_chunk(event, _provider) do

defmodule ExLLM.Providers.Mock do
  @moduledoc """
  ...
  The mock adapter can be configured with predefined responses or response generators:
      ...
      ExLLM.Providers.Mock.set_response_handler(fn messages, options ->
        %{content: "You said: \#{List.last(messages).content}"}
      end)
      
      # Simulate errors
      ExLLM.Providers.Mock.set_error({:api_error, %{status: 500, body: "Server error"}})
  ...
  ## Examples
      ...
      ExLLM.Providers.Mock.use_cached_responses(:openai)
      
      # Use cached Anthropic responses  
      ExLLM.Providers.Mock.use_cached_responses("anthropic")

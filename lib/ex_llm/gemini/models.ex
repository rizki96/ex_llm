defmodule ExLLM.Gemini.Models do
  ...
  defmodule Model do
    ...
    @enforce_keys [:name, :base_model_id, :version, :display_name, :description,
  ...
  def get_model(nil, _opts), do: {:error, %{reason: :invalid_params, message: "Model name is required"}}
  ...
  defp normalize_model_name(_), do: {:error, %{reason: :invalid_params, message: "Model name must be a string"}}

defmodule ExLLM.Plugs.Providers.GeminiParseListModelsResponse do
  ...
  defp get_known_context_window(model_name) do
    cond do
      model_name =~ ~r/gemini-1\.5-pro/ -> 2_097_152  # 2M context
      model_name =~ ~r/gemini-1\.5-flash/ -> 1_048_576  # 1M context
      model_name =~ ~r/gemini-2\.0-flash-exp/ -> 1_048_576  # 1M context

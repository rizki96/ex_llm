defmodule ExLLM.Infrastructure.Config.ModelCapabilities do
  @moduledoc """
  ...
  ## Usage
      ...
      {:ok, caps} = ExLLM.Infrastructure.Config.ModelCapabilities.get_capabilities(:openai, "gpt-4-turbo")
      
      # Check if a model supports a specific feature
      ExLLM.Infrastructure.Config.ModelCapabilities.supports?(:anthropic, "claude-3-opus-20240229", :vision)
      
      # Find models that support specific features
      models = ExLLM.Infrastructure.Config.ModelCapabilities.find_models_with_features([:function_calling, :streaming])
      
      # Compare models
      comparison = ExLLM.Infrastructure.Config.ModelCapabilities.compare_models([
        {:openai, "gpt-4"},
  ...
  ## Examples
      ...
      {:ok, info} = ExLLM.Infrastructure.Config.ModelCapabilities.get_model_info(:openai, "gpt-4o")
  """

defmodule ExLLM.TestCacheMatcher do
  @moduledoc """
  ...
  defp signatures_match?(sig1, sig2) do
    sig1.url == sig2.url and
      sig1.body_hash == sig2.body_hash and
      sig1.method == sig2.method and
      sig1.headers_signature == sig2.headers_signature
  end

defmodule ExLLM.Telemetry do
  ...
  2. **Metrics**: Use `ExLLM.Telemetry.Metrics` with `telemetry_metrics`
  3. **Tracing**: Use `ExLLM.Telemetry.OpenTelemetry` for distributed tracing

defmodule ExLLM.ContextIntegrationTest do
  ...
  describe "chat/3 with context management" do
    setup do
      ...
      messages = Enum.reduce(1..50, messages, fn i, acc ->
        acc ++ [
  ...
  describe "prepare_messages/2" do
    test "prepares messages with different strategies" do
      ...
      # Test sliding window
      sliding = ExLLM.prepare_messages(messages, 
        max_tokens: 200,
        strategy: :sliding_window
      )
      ...
      smart = ExLLM.prepare_messages(messages_with_system,
        max_tokens: 200,
        strategy: :smart
      )
  ...
  describe "validate_context/2" do
    test "validates context for different providers" do
      ...
      assert {:ok, tokens} = ExLLM.validate_context(messages,
        provider: "anthropic",
  ...
  describe "context_stats/1" do
    test "provides useful statistics" do
      messages = [
        ...
        %{role: "assistant", content: "It runs on the Erlang VM and is great for concurrent applications."}
      ]

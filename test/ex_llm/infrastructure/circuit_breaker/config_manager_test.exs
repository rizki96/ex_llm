defmodule ExLLM.Infrastructure.CircuitBreaker.ConfigManagerTest do
  ...
  setup do
    ...
    case ConfigManager.start_link() do
      {:ok, _pid} -> :ok
  ...
  describe "configuration updates" do
    ...
    test "updates both circuit breaker and bulkhead configuration" do
      ...
      bulkhead_config = ExLLM.Infrastructure.CircuitBreaker.Bulkhead.get_config(circuit_name)
  ...
  describe "integration with circuit breaker system" do
    ...
    test "bulkhead configuration changes affect concurrency" do
      ...
      task1 =
        Task.async(fn ->
          ExLLM.Infrastructure.CircuitBreaker.call_with_bulkhead(circuit_name, fn ->

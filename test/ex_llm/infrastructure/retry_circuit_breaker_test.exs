defmodule ExLLM.Infrastructure.RetryCircuitBreakerTest do
  use ExUnit.Case
  alias ExLLM.Infrastructure.Retry
  ...
  describe "circuit breaker with retry integration" do
    ...
    test "provider-specific configurations work correctly" do
      ...
      # Check circuit stats
      {:ok, stats} = ExLLM.Infrastructure.CircuitBreaker.get_stats(:openai_circuit)
  ...
  describe "provider configurations" do
    test "each provider has specific circuit breaker settings" do
      ...
      for provider <- providers do
        ...
        {:ok, stats} = ExLLM.Infrastructure.CircuitBreaker.get_stats(:"#{provider}_circuit")
  ...
  describe "options handling" do
    test "split_options separates circuit breaker and retry options" do
      ...
      {:ok, stats} = ExLLM.Infrastructure.CircuitBreaker.get_stats("custom")

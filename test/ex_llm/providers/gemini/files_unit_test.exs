defmodule ExLLM.Gemini.FilesUnitTest do
  ...
  alias ExLLM.Providers.Gemini.Files.{File, Status, VideoFileMetadata}
  ...
  describe "validate_file_path/1" do
    ...
    test "returns error for non-existent file" do
      assert {:error, %{reason: :file_not_found}} =
               Files.validate_file_path("/non/existent/file.txt")
    end
  ...
  describe "parse_timestamp/1" do
    ...
    test "handles timestamps with timezone offsets" do
      ...
      # 12:00 + 5:30 offset = 06:30 UTC
      assert timestamp.hour == 6

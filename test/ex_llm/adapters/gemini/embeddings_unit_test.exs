defmodule ExLLM.Gemini.EmbeddingsUnitTest do
  ...
  describe "normalize_model_name/1" do
    test "handles various model name formats" do
      ...
      assert Embeddings.normalize_model_name("models/text-embedding-004") == "models/text-embedding-004"
      assert Embeddings.normalize_model_name("gemini/text-embedding-004") == "models/text-embedding-004"
    end

defmodule ExLLM.Gemini.CachingTest do
  ...
  describe "create_cached_content/2" do
    test "successfully creates cached content with TTL" do
      ...
      large_text = String.duplicate("This is a large context that I want to cache for reuse. " <>
        ...
        "It allows us to reuse processed content across multiple requests efficiently. ", 50)
